...
Bomberman.ClassicState.prototype.init_hud = function () {
    ...
    player1_lives_position = new Phaser.Point(0.04 * this.game.world.width, 0.04 * this.game.world.height);
    ...
    player2_lives_position = new Phaser.Point(0.96 * this.game.world.width, 0.04 * this.game.world.height);
